...
*/
  ...
  Particle.function("stamp_data", stamp_data)
/*
...
*/
  ...
  //Default pH Stamp address = 99 (0x63)
    ph1.begin(0x63);
    ph2.begin(0x62);
    //ph2.enableLED();
  //Default RTD Temperature Stamp address = 102 (0x66)
    temp1.begin(0x66);
  //Default RTD Temperature Stamp address = 100 (0x64)
    EC1.begin(0x64);
